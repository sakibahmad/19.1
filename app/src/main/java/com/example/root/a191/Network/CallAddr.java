package com.example.root.a191.Network;
 ...
 */
        ...
        import com.example.root.a191.CommonUtilities;
...
public class CallAddr extends AsyncTask<String, Void, String> {
    ...
    public CallAddr(Context context, String url, FormEncodingBuilder formBody, CommonUtilities.SERVICE_TYPE Servicetype, WebService resultListener) {
